...
{
    public partial class FormNouInteressat : Form
    {

        private Connexio mysqlconnect;
        public FormNouInteressat(Connexio connect)
        {
        ...
        private void btInserir_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string Query = "SELECT COUNT(*) FROM ComercialParticulars WHERE((Nom=@param_Nom)AND (Cognoms=@param_Cognoms))";
                MySqlCommand cmd = new MySqlCommand(Query, conn);
               cmd.Parameters.AddWithValue("@param_Nom", txtBNom.Text.ToUpper());
                ...
                reader.Close();
                Query = "SELECT COUNT(*) FROM ComercialParticulars WHERE(`Correu electrònic`=@param_Email)";
                ...
                {
                    Query = "INSERT INTO ComercialParticulars(Nom,Cognoms,`Curs d'interès`,Mes,Informat, `Correu electrònic`,Comentaris,Telèfon,`Telèfon Mòbil`,`Data de preferència` ) "
                        + "VALUES(@param_Nom,@param_Cognoms,@param_Cursos,@param_mes,@param_Informat,@param_Email,@param_Comentaris,@param_Telefon,@param_TelefonMobil,@DataPrefer);";
                    cmd = new MySqlCommand(Query, conn);
                    cmd.Parameters.AddWithValue("@param_Nom", txtBNom.Text.ToUpper());
                    cmd.Parameters.AddWithValue("@param_Cognoms", txtBCognoms.Text.ToUpper());
